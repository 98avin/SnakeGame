...
public class SnakePanel extends JPanel {
    ...
    static Snake bernita;
      ...
      // double offsetMaxX = getHeight(); // getting the total length of the screen for scrolling
       // double offsetMaxY = getWidth(); // same for the screen width
        double offsetMinX = 0; // just in case
        double offsetMinY = 0; // owen is a poop
        
//        int camX = bernie.getX() - getWidth() / 2;
        //int camY = bernita.getY() - getHeight() / 2;
